...
function AdminVillas() {
  ...
  const getVillasList = async() => {
    try {
      ...
      let res = await AxiosService.get(`${ApiRoutes.GETADMINVILLASLIST.path}?type=Villa`,{ headers : { 'Authorization' : `${getLoginToken}`} })
      setLists(res.data.villasList)
    } catch (error) {
